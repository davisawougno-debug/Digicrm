...
<aside class="admin-sidebar commercial-sidebar" id="commercialSidebar">
    ...
    <div class="sidebar-user-card">
        ...
        <div class="sidebar-user-info">
            ...
            <div class="sidebar-user-role">Commercial</div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'dashboard') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'prospects') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=prospects" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'clients') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=clients" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'devis') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=devis" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'contrats') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=contrats" class="sidebar-link">
                    <i class="fas fa-file-signature"></i>
                    <span>Contrats</span>
                </a>
            </li>

            <li class="sidebar-divider"><span>Planification</span></li>

            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'rendez-vous') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=rendez-vous" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'notifications') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=notifications" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'rapports') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=rapports" class="sidebar-link">
            ...
            <li class="sidebar-item <?= (($_GET['module'] ?? 'dashboard') === 'profil') ? 'active' : '' ?>">
                <a href="<?= BASE_URL ?>/commercial_index.php?module=profil" class="sidebar-link">
